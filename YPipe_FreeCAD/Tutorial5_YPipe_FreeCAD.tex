...
\begin{document}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Clik on \texttt{Search} to pick an inner point for the mesh
			...
			\item When the mesh is complete it can be viewed with \texttt{ParaView}. Teh result should be similar to the \texttt{snappy} stage of Tutorial \#4. 
		\end{itemize} 
		...
		\begin{itemize}
			...
			\item Run the solver. It will not converge completely. We should change numerical schemes or other solver settings in order to get a better convergence, but it is beyond the scope of this Tutorial. It will take about 5 minuts to complete the 100 iterations
			...
			\begin{itemize}
				...
				will be visible.
				\item Apply the filter \texttt{Integrate Variables}, with \texttt{Cell data as atribute}.
